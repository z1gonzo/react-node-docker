...
const getSassLoaderOptions = o => {
    (o !== null && o !== void 0 ? o : (o = {})).__exePath = require.resolve(`sass-embedded-${process.platform}-${process.arch}/dart-sass-embedded/dart-sass-embedded${process.platform === "win32" ? ".bat" : ""}`);
    return o;
};
...
function getBuiltinLoaderOptions(identifier, o, options) {
    if (identifier.startsWith(`${BUILTIN_LOADER_PREFIX}sass-loader`)) {
        (0, util_1.deprecatedWarn)(`'builtin:sass-loader' has been deprecated, please migrate to ${(0, util_1.termlink)("sass-loader", "https://github.com/webpack-contrib/sass-loader")}`);
...
//# sourceMappingURL=adapterRuleUse.js.map