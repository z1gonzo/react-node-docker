    ...
    compilation: {
        _: (object, compilation, context, options) => {
            ...
            if (logging || (loggingDebug && loggingDebug.length > 0)) {
                ...
                for (const { name, ...rest } of context._inner.getLogging(acceptedTypes)) {
        ...
        hash: (object, _compilation, context) => {
        ...
        assets: (object, _compilation, context, options, factory) => {
        ...
        chunks: (object, _compilation, context, options, factory) => {
            const { type } = context;
            const chunks = context._inner.getChunks(options.chunkModules, options.chunkRelations, options.reasons, options.moduleAssets, options.nestedModules, options.source);
            object.chunks = factory.create(`${type}.chunks`, chunks, context);
        },
        modules: (object, compilation, context, options, factory) => {
            const { type } = context;
            const array = context._inner.getModules(options.reasons, options.moduleAssets, options.nestedModules, options.source);
        ...
        entrypoints: (object, _compilation, context, _data, _factory) => {
            // const { type } = context;
        ...
        chunkGroups: (object, _compilation, context, _options, factory) => {
            const { type } = context;
...
//# sourceMappingURL=DefaultStatsFactoryPlugin.js.map