...
class ModuleFederationPlugin {
    ...
    apply(compiler) {
        ...
        new webpack.EntryPlugin(compiler.context, getDefaultEntryRuntime(this._options, compiler), { name: undefined }).apply(compiler);
...
function getImplementation(options) {
    var _a;
    return ((_a = options.implementation) !== null && _a !== void 0 ? _a : require.resolve("@module-federation/runtime-tools/webpack-bundler-runtime"));
}
function getDefaultEntryRuntime(options, compiler) {
    ...
    const content = [
        `import __module_federation_runtime__ from ${JSON.stringify(implementationPath)}`,
