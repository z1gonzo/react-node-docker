import type { ArrayOrNot, ChainedConfigWithUtils, ChainedConfigCombineUtils } from '../utils';
...
export type HtmlInjectTagHandler = (tags: HtmlInjectTag[], utils: HtmlInjectTagUtils) => HtmlInjectTag[] | void;
